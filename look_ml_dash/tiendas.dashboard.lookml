- dashboard: tiendas
  ...
  description: ''
  preferred_slug: wf3ntkkyEVBd6VncyV1UTx
  elements:
  - title: Comparativo por tiendas
    name: Comparativo por tiendas
    model: tac_project
    explore: demo_tac
    type: looker_grid
    fields: [demo_tac.agrupacion, demo_tac.Valor_moneda, demo_tac.Valor_presupuesto,
      demo_tac.tienda]
    pivots: [demo_tac.tienda]
    sorts: [demo_tac.tienda, demo_tac.Valor_moneda desc 0]
    limit: 500
    column_limit: 50
    dynamic_fields:
    ...
    width: 24
    height: 6
  - title: Total de ingresos por tienda
    name: Total de ingresos por tienda
    model: tac_project
    explore: demo_tac
    type: looker_column
  ...
  - name: ''
    ...
    body_text: |-
      ...
      <a style="padding: 5px 15px; border-top: solid 1px #4285F4; border-left: solid 1px #4285F4; border-right: solid 1px #4285F4; border-radius: 5px 5px 0 0; float: left; line-height: 40px; font-wght: bold; background-color: #eaf1fe;" href="#"> Tiendas</a>
